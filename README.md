...
- Extracted markdown + images: [docs/e760-users-manual/](docs/e760-users-manual/)
...
| **Lamp / fan** | Lamps **GPIO26** + LED **GPIO2**; **#** holds ~2 s warmup then counts dose; fan **GPIO27** on with lamps, **30 s** rundown after off |
